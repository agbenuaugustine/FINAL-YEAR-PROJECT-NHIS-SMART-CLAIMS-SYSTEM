 ...
 * Visits Page
 * 
 * Displays and manages patient visits
 */
...
<head>
    ...
    <title>Patient Visits - Smart Claims</title>
...
<body>
    ...
    <div class="app-container">
        ...
        <div class="page-header">
            ...
            <div class="page-actions">
                <a href="new-visit.php" class="btn btn-primary">
        ...
        <div class="search-container">
            <div class="search-input">
                ...
                <input type="text" id="search-input" placeholder="Search by patient name or NHIS number...">
            </div>
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody id="visits-table">
                        <tr>
                            <td colspan="7" class="text-center py-4">Loading visits...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="mobile-nav">
        ...
        <a href="visits.php" class="mobile-nav-item active">
            <i class="fas fa-clipboard-list"></i>
            <span>Visits</span>
        </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadVisits() {
                ...
                tableBody.innerHTML = '<tr><td colspan="7" class="text-center py-4">Loading visits...</td></tr>';
                ...
                fetch(`/smartclaimsCL/api/visits.php?${params}`)
                    .then(response => response.json())
                    .then(data => {
                        if (data.status === 'success') {
                            displayVisits(data.data.visits);
                            updatePagination(data.data.pagination);
                        } else {
                            tableBody.innerHTML = '<tr><td colspan="7" class="text-center py-4">Failed to load visits</td></tr>';
                            console.error('Error loading visits:', data.message);
                        }
                    })
                    .catch(error => {
                        tableBody.innerHTML = '<tr><td colspan="7" class="text-center py-4">Failed to load visits</td></tr>';
            ...
            function displayVisits(visits) {
                ...
                if (!visits || visits.length === 0) {
                    tableBody.innerHTML = '<tr><td colspan="7" class="text-center py-4">No visits found</td></tr>';
                    return;
                }
                ...
                visits.forEach(visit => {
                    ...
                    const visitDate = new Date(visit.visit_date).toLocaleString();
                    
                    html += `
                        <tr>
                            <td>${visitDate}</td>
                            <td>${visit.patient_name}</td>
                            <td>${visit.nhis_number || 'N/A'}</td>
                            <td>${visit.visit_type}</td>
                            <td>${visit.chief_complaint}</td>
                            <td><span class="status-badge ${statusClass}">${visit.status}</span></td>
                            <td>
                                <a href="visit.php?id=${visit.id}" class="btn btn-sm btn-primary">
